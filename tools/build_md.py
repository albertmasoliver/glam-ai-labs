...
`Helsinki-NLP/opus-mt-*` family.''', [1, 2, 3, 4]),
 ...
 (3, "The Transformer, in three shapes", '''Every modern language model is a **Transformer**, stacked from two kinds of building block.
...
| Encoder-decoder | bi + cross | map input → output | seq-to-seq: translate, summarize | T5, BART, Marian |''', [5, 6]),
